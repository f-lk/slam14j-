...
int main ( int argc, char** argv )
{
 ...
 //   printf("%d",K.at<double>(0,0));
    ...
    {
        Point2d pt1 = pixel2cam ( keypoints_1[ m.queryIdx ].pt, K );//××将p1转化为x1//queryIdx是图片img1中进行匹配的序号
        ...
        cout<<pt1.x<<endl;
        Point2d pt2 = pixel2cam ( keypoints_2[ m.trainIdx ].pt, K );//××trainIdx是图片img2中与图片img1中queryIdx对应的序号
